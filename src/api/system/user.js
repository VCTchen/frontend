...
export function getUser(userId) {
  return request({
    url: '/adminApi/user/' + praseStrEmpty(userId),
    method: 'get'
  })
}
...
export function updateUserPwd(oldPassword, newPassword) {
  ...
  return request({
    url: '/adminApi/user/profile/updatePwd',
    method: 'put',
    params: data
  })
}
...
export function uploadAvatar(data) {
  return request({
    url: '/adminApi/user/profile/avatar',
    method: 'post',
    data: data
  })
}
...
export function importTemplate() {
  return request({
    url: '/adminApi/user/importTemplate',
    method: 'get'
  })
}
